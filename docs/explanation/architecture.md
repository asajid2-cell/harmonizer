...
| `frontend/` | Static pages and browser-side applications, including Harmonizer and Night Library. |
...
Ignored runtime data includes uploads, local audiobook files, generated analysis files, local SQLite databases, browser cookies, model checkpoints, Playwright screenshots, CodeSniff indexes, and local SDK installs.
