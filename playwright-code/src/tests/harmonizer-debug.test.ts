...
(async () => {
  ...
  try {
    ...
    const windowObjects = await page.evaluate(() => {
      return {
        hasVisualizer: typeof (window as any).visualizer !== 'undefined',
        hasHarmonizerApp: typeof (window as any).HarmonizerApp !== 'undefined',
        hasCanvasVisualizer: typeof (window as any).CanvasVisualizer !== 'undefined',
        hasModeManager: typeof (window as any).ModeManager !== 'undefined',
